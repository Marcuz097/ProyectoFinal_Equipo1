...
class Paciente(models.Model):
    ...
    usuario = models.OneToOneField(User, on_delete=models.CASCADE, primary_key=True, blank=True)
...
class Cita(models.Model):
    id_cita = models.AutoField(primary_key=True, blank=True)
    fecha_hora = models.DateTimeField(blank=True) # Un solo campo para fecha y hora
    ...
    paciente = models.ForeignKey(Paciente, on_delete=models.CASCADE, related_name='citas_paciente', blank=True)
    # Relación Uno a Muchos (1:N) con Medico
    medico = models.ForeignKey(Medico, on_delete=models.CASCADE, related_name='citas_medico', blank=True)
